...
<html>
<head>
	<title>Pending Accounts | RTMS</title>
	<meta charset="UTF-8">
...
<section id="rtms">
	...
	<div class="main-panel">
		...
		<div id="target">
			<!-- Start -->
			<div id="validation" class="relative"></div>
			...
			<!-- End $('#validation').html('<div class="validation-handler error-handle"><img src="assets/svg/error.svg"><span class="danger">An error occurred. Please try again later.</span></div>');-->
		</div>
	</div>
</section>

<script src="../assets/query/profile-photo.js"></script>
<script src="../assets/query/pending-accounts.js"></script>
